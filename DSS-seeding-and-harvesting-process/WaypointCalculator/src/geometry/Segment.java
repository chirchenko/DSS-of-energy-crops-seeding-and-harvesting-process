...
public class Segment implements Displayable{
	...
	/*
	 * Перевірка, Чи належить точка відрізку?
	 * якщо сума відстаней до початку і кінця відрізку дорівнює довжині відрізку то точка лежить на ньому
	 */
