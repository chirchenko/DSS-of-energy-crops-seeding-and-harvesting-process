...
public class WaypointFinder {
	...
	public WaypointFinder(List<domains.Points.Point> points, double width) {
		...
		/*
		 * 2)Знайти область визначення фігури відносно відрізка base та Отримаємо пряму на якій лежить відр. base
		 */
		...
		/*
		 * 3) Поділити відрізок ovf на devidor, знайти координати точок розподілу: devisionPoints[u-1]
		 */
